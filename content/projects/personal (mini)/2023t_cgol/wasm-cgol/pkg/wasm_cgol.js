...
export class GameOfLife {
     ...
     */
    static new(w, h, wrap) {
        const ret = wasm.gameoflife_new(w, h, wrap);
     ...
     * @returns {GameOfLife}
     */
    static load(w, h, cells, wrap) {
        const ret = wasm.gameoflife_load(w, h, cells, wrap);
        return GameOfLife.__wrap(ret);
    }
    /**
     * @returns {number}
     */
    ptr() {
        const ret = wasm.gameoflife_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    clear() {
     ...
     */
    wrap(val) {
        wasm.gameoflife_wrap(this.__wbg_ptr, val);
    }
    tick() {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_cgol_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
